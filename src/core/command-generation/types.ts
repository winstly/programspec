...
export interface CommandContent {
  /** Command identifier (e.g., 'init', 'run', 'status') */
  id: string;
  /** Human-readable name (e.g., 'programspec Init') */
  name: string;
...
export interface ToolCommandAdapter {
   ...
   * @param commandId - The command identifier (e.g., 'init')
   * @returns Path from project root (e.g., '.claude/commands/programspec/init.md').
   */
